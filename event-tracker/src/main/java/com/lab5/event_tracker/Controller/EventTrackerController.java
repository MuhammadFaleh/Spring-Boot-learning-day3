...
public class EventTrackerController {
    ...
    public ApiResponse eventUpdate(@PathVariable int index, @RequestBody EventTrackerSystem event) {
    ...
    public ApiResponse eventCapacityUpdate(@PathVariable int index, @RequestBody EventTrackerSystem event) {
        if (events.size() > index) {
    ...
    public ApiResponse eventDelete(@PathVariable int index){
        if(events.size() > index){
            events.remove(index);
